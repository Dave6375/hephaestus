        ...
        >
            <FieldGroup>
                <div className="flex flex-col items-center gap-2 text-center">
                    <div className="flex size-10 items-center justify-center rounded-lg bg-primary text-primary-foreground mb-1">
                        <Icons.logo className="size-6" />
                    </div>
                    <h1 className="font-bold text-2xl">Continue to {siteConfig.name}</h1>
                </div>
